...
export default function AdminLoanDetailPage() {
  ...
  return (
    <AdminLayout
      title="Loan Detail"
      subtitle="Full loan application information"
      mainBg="bg-slate-900"
    >
        ...
        <div className="flex items-center justify-between mb-8 animate-fade-in">
          <div>
            ...
            <p className="text-slate-400 mt-1 text-sm">
              Full loan application information
            </p>
          </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    },
                    {
                      ...
                      value: formatCurrency(loan.monthlyExpense),
                    },
                    {
                      label: "Applied Date",
                ...
                {loan.riskScore !== undefined && (
                  <div className="mt-4">
                    <div className="flex justify-between text-xs text-slate-400 mb-1.5">
                      ...
                      <span>{loan.riskScore?.toFixed(1)}/100</span>
                    </div>
                    <div className="h-2 bg-slate-700 rounded-full overflow-hidden">
                      <div
                        className={`h-full rounded-full transition-all ${loan.riskLevel === "LOW" ? "bg-emerald-500" : loan.riskLevel === "MEDIUM" ? "bg-amber-500" : "bg-red-500"}`}
                        style={{
